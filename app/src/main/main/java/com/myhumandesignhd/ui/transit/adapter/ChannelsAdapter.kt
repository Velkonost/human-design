...
class ChannelsAdapter : EpoxyAdapter() {
    ...
    fun createList(
        ...
        if (fromAbout) {
            addModel(AboutChannelsTitleModel())
        }
...
class AboutChannelsTitleModel(): EpoxyModel<View>() {
    ...
    override fun bind(view: View) {
        ...
        with(view) {
            ...
            activeGatesDesc.text = App.resourcesProvider.getStringLocale(R.string.active_channels_text)
