...
import com.myhumandesignhd.ui.view.daytimepicker.DateHelper;
import com.myhumandesignhd.ui.view.daytimepicker.LocaleHelper;
...
public abstract class MyWheelPicker<V> extends View {
    ...
    protected Listener<MyWheelPicker, V> listener;
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (onItemSelectedListener != null) {
                    onItemSelectedListener.onCurrentItemOfScroll(MyWheelPicker.this, position);
                }
    ...
    public interface OnItemSelectedListener {
        void onItemSelected(MyWheelPicker picker, Object data, int position);

        void onCurrentItemOfScroll(MyWheelPicker picker, int position);
    }
    ...
    protected interface Listener<PICKER extends MyWheelPicker, V> {
