package ru.get.hd.ui.view.daytimepicker.widget;
...
//            com.github.florent37.singledateandtimepicker.widget.WheelYearPicker yearPick = (com.github.florent37.singledateandtimepicker.widget.WheelYearPicker) this;
            Calendar calendar = Calendar.getInstance();
            calendar.setTimeZone(dateHelper.getTimeZone());
            calendar.setTime(date);
            final int indexOfDate = adapter.getData().indexOf(String.valueOf(calendar.get(Calendar.YEAR)));//findIndexOfDate(date);
            if (indexOfDate >= 0) {
