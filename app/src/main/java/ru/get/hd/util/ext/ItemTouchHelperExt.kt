...
//            val conversationModel = (recyclerView.adapter as NotesAdapter).getNoteAt(position)
//            val canSwipe = conversationModel.noteType != UserDiaryFields.NoteType.HabitRealization.id
